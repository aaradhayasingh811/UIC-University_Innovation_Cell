...
//     </div>*/}
			...
			<div className="space-y-4">
				<img alt="" className="object-cover h-56 mx-auto mb-4 bg-center rounded-sm dark:bg-gray-500" style={{  objectFit: "fill"
}} src={props.imgSrc} />
				<div className="flex flex-col items-center">
					<h4 className="text-xl font-semibold text-[#8f7546]">{props.name}</h4>
					<p className="text-sm dark:text-gray-600">{props.post}</p>
					<div className="flex mt-2 justify-around items-center">
						...
						<a rel="noopener noreferrer" href="#" title="LinkedIn" className="dark:text-gray-600 mx-auto">
